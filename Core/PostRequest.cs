...
namespace EvoWeb.Core
{
    public class PostRequest
    {
        ...
        public async Task<ActionResult> GetDataFromApi(string sessionid, string body)
        {
            // Példa API URL
            string apiUrl = "https://evoweb-api.reigdev.hu/api/v1/Post/?sessionid=" + sessionid + "&body=" + body;
